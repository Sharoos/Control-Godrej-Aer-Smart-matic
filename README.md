...
1. **Find your Device MAC Address** To control your specific unit, you need its unique hardware address. You can find this in two ways:
   * **From the Godrej aer App:** Open the app, go to your paired device, and look for the MAC Address (e.g., `A1:D6:63:E9:5H:92`) in the Settings or Device Info menu.
...
2. **Configure the Script** In the provided `spray.py` file, locate the `ADDRESS` variable at the top and replace the placeholder with your retrieved address:
